...
AC_SAMPLE_INTERVAL = 0.5 #  0.2 #0.5 # 0.1 # 1 #(IMPORTANT: 1 AC iteration admits only 1 or 0 session) check for any new or deferred sessions make AC decisions 
...
# Simulation time
TARGET_N_SESSION=1000 #1 overloaded with 500, lets see with 1000
