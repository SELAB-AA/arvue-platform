...
##                        self.sim.admissionController.arrived_sessions[0].server.njobs=self.sim.admissionController.arrived_sessions[0].server.njobs-1
...
##                    print "---------------- self.reqNo > 0 is true: self.name", self.name, "self.reqNo", self.reqNo                    
                ...
                if len(self.sim.admissionController.arrived_sessions) > 1:
                    print "-------------- No. of arrived sessions > 1 is true", len(self.sim.admissionController.arrived_sessions)
...
##                yield passivate, self
    ...
    ##            else:
    ##                #print "skipped the RT observation", self.name
