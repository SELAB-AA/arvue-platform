...
plot "sim-report.dat" using ($1/3600):8 smooth csplines with lines title "overloaded servers" axis x1y1, \
...
plot "sim-report.dat" using ($1/3600):11 with lines title "weighted CPU load average", 1.0 lc 4 axis x1y1, \
     "sim-report.dat" using ($1/3600):12 with lines title "weighted memory utilization" axis x1y2
