...
##            yield request,self,self.server
        ...
        if random.uniform(0,1) < 0.4 or (self.sim.phase==1 or self.sim.phase==3 or self.sim.phase==5 or self.sim.phase==7 or self.sim.phase==9 or self.sim.phase==10 or self.sim.phase==12):
