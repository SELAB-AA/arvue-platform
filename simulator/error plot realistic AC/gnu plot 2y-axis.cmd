...
plot "acvas-report.dat" using ($1/3600):(abs(0.8 - $5)) with lines title "ACVAS error", \
     "alternative-report.dat" using ($1/3600):(abs(0.8 - $5)) with lines title "Alternative error" lc 3
